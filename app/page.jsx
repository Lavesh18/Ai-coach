...
import { sectionContent } from "@/utils/menuItems";
  ...
  return (
    <div>
      ...
      <section className="w-full py-12 md:py-24 bg-muted/50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {sectionContent.map((cover,index) => (
              <div key={index} className="flex flex-col items-center justify-center space-y-2">
                <h3 className="text-4xl font-bold">{cover.quants}</h3>
                <p className="text-muted-foreground">{cover.content}</p>
              </div>
            ))}
          </div>
        </div>
                ...
                <CardContent className="pt-6">
                  <div className="flex flex-col space-y-4">
                    <div className="flex items-center space-x-4">
                      <div className="relative h-12 w-12 fex-shrink-0">
                        <Image
                          src={test.image}
                          alt={test.author}
                          width={40}
        ...
        <div className=" mx-auto py-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold tracking-tighter text-primary-foreground sm:text-4xl md:text-5xl">
              Ready To Accelarate Your Carrer?
            </h2>
